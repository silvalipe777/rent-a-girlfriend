...
const CARTOON_PROMPTS: Record<string, string> = {
  ...
  Valentina: "Stunning anime woman, 26 years old, sleek dark hair in glamorous waves, striking green eyes with smoky makeup, confident smile, elegant black dress, luxury lounge background with neon lights, anime art style, detailed digital illustration, sophisticated aesthetic, high quality anime portrait, dramatic lighting, rich colors, manga style beauty",
